...
uint256 hashGenesisBlock("0xd1b4a029a3acd955d1ca27b742b88b37c2cab9c0c11674cc2f0681d3fb86a79a");
...
const string strMessageMagic = "ExBit Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ExBit: 1 days
static const int64 nTargetSpacing = 120; // ExBit: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal exbit miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ExBit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x666c570de2666ab2db0b9c852610ee2e0b85ed4c7f2f2dc6702c844234b7489b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1504643000; //1504530833;//1300000000; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 765971;

        if (fTestNet)
        {
            block.nTime    = 1504530833;//1300000000;
            block.nNonce   = 607875;
        }
